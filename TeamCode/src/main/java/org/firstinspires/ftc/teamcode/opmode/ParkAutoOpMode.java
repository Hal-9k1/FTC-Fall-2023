...
import org.firstinspires.ftc.teamcode.path.ParkPathPlanner;
...
public class ParkAutoOpMode extends OpMode {
  ...
  @Override
  public void loop() {
    //pilot.updateWithTags(cameraTransformRS, new ArrayList<>());
    //pathPlanner.acceptSpikeTransforms(new ArrayList<>());
    if (pathPlanner.tick()) {
